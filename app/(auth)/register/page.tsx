        ...
        <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <ThreeDCard className="w-full max-w-md">
                <div className="text-center space-y-4 mb-4">
                    ...
                    <p className="text-sm text-slate-400 tracking-wide font-light">Join the elite network</p>
                </div>
                ...
                <div className="relative py-8">
                    ...
                    <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-medium">
                        <span className="bg-[#020617] px-3 text-slate-500 rounded-full border border-white/5">Or register with</span>
                    </div>
                </div>

                <PremiumButton variant="secondary" className="w-full border-white/5 bg-white/5 hover:bg-white/10 text-white/90 py-5" onClick={handleGoogleRegister} isLoading={isLoading}>
                ...
                <div className="text-center text-sm text-slate-400 font-light mt-8">
                    ...
                    <Link href="/login" className="text-violet-400 hover:text-white transition-colors font-bold ml-1 hover:underline decoration-violet-500 underline-offset-4">
                        Sign In
                    </Link>
                </div>
            </ThreeDCard>
